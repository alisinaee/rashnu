(function () {
  ...
  const translations = {
    fa: {
      ...
      heroSubtitle: "راهنمای استفاده از افزونه مقایسه قیمت Dirob",
      whatTitle: "این افزونه چه کار می‌کند؟",
      whatBody: "Dirob هنگام مرور صفحات لیست و جزئیات محصول در <strong>دیجیکالا</strong>، <strong>ترب</strong> و <strong>تکنولایف</strong>، نتیجه‌ی مقایسه را برای چندین فروشگاه از جمله ایمالز، آمازون و eBay در پنل کناری نمایش می‌دهد.",
    ...
    en: {
      ...
      heroSubtitle: "Guide to using the Dirob comparison extension",
      whatTitle: "What does this extension do?",
      whatBody: "Dirob watches listing and product-detail pages on <strong>Digikala</strong>, <strong>Torob</strong>, and <strong>Technolife</strong>, then shows multi-provider comparison results (including Emalls, Amazon, and eBay) in the side panel.",
